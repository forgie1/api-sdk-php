 ...
 * @property int $ean // * reguired, or id_product
 * @property int $id_product // * required, or ean
 * @property int $id_offer // * required, string, Seller's unique ID for offer(s)
...
class UnitAddTransfer extends AbstractTransfer
{
	...
	{
		return AbstractTransfer::makeTransfer('Hitmeister\Component\Api\Transfers\UnitAddTransfer', $data);
	}
}
